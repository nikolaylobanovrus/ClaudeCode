    ...
    ? [
        {
          ...
          a: "Да. На шаге «О вас» загрузите фото или PDF — справку о доходах (2-НДФЛ), паспорт, договор, справки об оплате лечения или обучения. Сервис распознает документы и заполнит пустые поля анкеты; то, что вы ввели сами, не изменится. Файлы передаются по защищённому каналу и нигде не сохраняются.",
        },
      ]
    : []),
  {
