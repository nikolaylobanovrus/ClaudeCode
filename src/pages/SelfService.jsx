    ...
    <>
      ...
      <section className="section" id="sd-vychety">
        <div className="container">
          ...
          {/* Продали имущество и ещё не знаете, будет ли налог, — калькулятор
              отвечает на это до анкеты. Реклама по «сколько налог с продажи»
              приводит такой трафик стабильно. */}
          <p className="sd-grid__note">
            Продали квартиру или машину и не знаете, будет ли налог?{" "}
            <Link to="/deklaraciya/kalkulyator-naloga-s-prodazhi">
              Посчитайте на калькуляторе
            </Link>{" "}
            — бесплатно, с проверкой срока владения.
          </p>
        </div>
      </section>
