        ...
        setDocs([
          {
            ...
            note:
              draft.year >= 2025
                ? "Напечатана на официальном бланке ФНС (приказ ЕД-7-11/913@) — как из программы налоговой. Заявление о возврате уже внутри (Приложение к Разделу 1)."
                : "PDF для печати и самопроверки. Заявление о возврате уже внутри (Приложение к Разделу 1).",
