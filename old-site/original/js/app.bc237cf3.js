(function(t) {
    ...
    "56d7": function(t, e, s) {
        ...
        var T = function() {
                ...
                }, [t._v("Публичная оферта")])]), s("v-divider"), s("v-card-text", [t._v(" ООО «Налог-сервис» использует файлы cookie с целью персонализации сервисов и повышения удобства пользования веб-сайтом. "), s("br"), t._v("Если вы не хотите использовать файлы cookie, измените настройки браузера. ")])], 1)], 1)
            },
            q = [],
            O = {
                data: function() {
                ...
                data: function() {
                    return {
                        prices: [{
                            ...
                            title: "Базовый",
                            titleChips: "-10%",
                            subtitle: "Получите готовую декларацию 3-НДФЛ.",
                            ...
                            title: "Премиум",
                            titleChips: "-10%",
                            subtitle: "Мы сделаем все за вас.",
        ...
        var bt = function() {
            ...
            xt = {
                data: function() {
                    return {
                        panels: [{
                            href: "https://t.me/+79127916470",
                            img: s("a20f"),
                            text: "Написать в Telegram",
                            textStyle: "color: #095e82"
                        }, {
                            href: "viber://chat?number=%2B79127916470",
                            img: s("b597"),
                            text: "Написать в Viber",
                            textStyle: "color: #311f9d"
                        }, {
                            href: "https://wa.me/79127916470",
                            img: s("3279"),
                            text: "Написать в WhatsApp",
                            textStyle: "color: #0c893b"
                        }]
                    }
                }
            },
                ...
                computed: {
                    ...
                    rateDescription: function() {
                        switch (this.form.rate) {
                            ...
                            case "Оптимальный (1 210 ₽)":
                                return "Готовим для Вас декларацию 3-НДФЛ и заявление на возврат налога, а также иные документы в зависимости от Вашей ситуации";
                            case "Базовый (990 ₽)":
                ...
                data: function() {
                    return {
                        items: [{
                            ...
                            text: 'Вы можете отправить фотографии или скан-копию документов любым удобным способом: <a href="mailto:NALOG-SERVICE@INTERNET.RU" target="_blank">электронная почта</a>, мессенджеры (<a href="https://wa.me/79127916470" target="_blank">WhatsApp</a>, <a href="viber://chat?number=%2B79127916470" target="_blank">Viber</a> и <a href="https://t.me/+79127916470" target="_blank">Telegram</a>).'
                        }, {
                            title: "Сколько времени занимает подготовка документов?",
                            text: "Срок подготовки документов – в течение 3 рабочих дней с момента получения всех запрошенных документов."
                        }, {
