...
**Скрипт выкладки изменился 13.09.2026** — на сервере нужно обновить его
...
вкладкой адреса кусков прежней сборки уже в памяти страницы, и после выкладки
они ведут в 404: вместо анкеты человек видит экран аварии. Мобильный Safari
держит вкладки сутками. (Повод к правке — всплеск ошибок с iPhone 11–13.09 —
при разборе объяснился иначе: люди уходили, не дождавшись загрузки. Отсрочка
удаления от этого не стала менее нужной, но и всплеск она не лечит.)
