        ...
        properties: {
          ...
          monthly: {
            ...
            description:
              ...
              "без нарастающего итога — сумма ЗА месяц. В разделе 3 строки идут по месяцам (01…12) " +
              "и кодам дохода; если за один месяц несколько строк с разными кодами — сложи их. " +
              ...
              "итогом ещё не превысил предел, и по среднему за год месяцы считаются неверно.",
            items: money,
          },
        },
      },
