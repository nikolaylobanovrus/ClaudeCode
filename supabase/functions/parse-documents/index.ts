...
const EXTRACT_SCHEMA = {
  type: "object",
  additionalProperties: false,
  required: ["personal", "incomes", "property", "medical", "education", "iis", "insurance", "warnings"],
  properties: {
    personal: section(
      {
