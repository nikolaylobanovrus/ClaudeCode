    ...
    personal: section(
      {
        ...
        phone: { type: "string", description: "Номер контактного телефона налогоплательщика, только цифры (11 цифр, начиная с 7) — с титульного листа декларации («Номер контактного телефона») или из шапки справки" },
        ifns: { type: "string", description: "Код налоговой инспекции, 4 цифры — с титульного листа ранее поданной декларации 3-НДФЛ («Представляется в налоговый орган (код)»)" },
        oktmo: { type: "string", description: "ОКТМО налогоплательщика по месту жительства (Раздел 1 ранее поданной декларации 3-НДФЛ); НЕ путать с ОКТМО работодателя из справки о доходах" },
      },
